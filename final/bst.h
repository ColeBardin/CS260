...
/**
 * @brief Compares two Binary Search Trees to determine if they are identical
 * 
 * @param S1 Tree to compare
 * @param S2 Tree to compare
 * @return char 0 for false, 1 for true
 */
char identical(BST *S1, BST *S2);

/**
 * @brief Recursively checks if the tree from a given node is identical
 * 
 * @param N1 Node to start at
 * @param N2 Node to start at
 * @return char 0 for false, 1 for true
 */
